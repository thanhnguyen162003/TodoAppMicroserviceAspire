using Todo.App.Application.Common.Interfaces;
using Todo.App.Application.Common.Mappings;
using Todo.App.Application.Common.Models;

namespace Todo.App.Application.TodoItems.Queries.GetTodoItemsWithPagination;
