...
using User.App.ConnectedServiceClients.Catalogs;
using User.App.KiotaClients.Catalogs;
using User.App.Shared.Clients;
using User.App.Shared.Clients.ConnectedService;
using User.App.Shared.Clients.Kiota;
using User.App.Shared.Clients.Rest;

namespace User.App.Shared.Extensions.WebApplicationBuilderExtensions;
